...
Rule~110---the red cells, $30\%$ of the genotype at the representative seed
($31\%$ over six seeds)---and the phenotype accordingly displays Rule~110's
...
local templates, and falls back to the cell's own local rule produces a
...
template-matching construction (fallback: the cell's own local rule), produces in
...
At the representative seed, $30\%$ of its genotype cells are Rule~110 and it
sustains $14$ distinct rules, against a foil that holds Rule~110 below $2\%$
and sustains $17$; over the six-seed sample the ordering is unchanged---Rule
110 $31\%$ (range $26$--$41\%$) versus $2\%$ ($1$--$3\%$), sustained diversity
$18$ versus $22$. On this pair, recovering a universal rule and sustaining a
