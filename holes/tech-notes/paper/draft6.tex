...
\newcommand{\supptheory}[2]{\footnote{Supplement~2, #1: #2.}}
\newcommand{\suppfinding}[2]{\footnote{\suppfindingref{#1}: #2.}}
...
we quote its permutation or apply names such as offset $+2$.\supptheory{Definition~1}{Writings, elementary writes, and propagators}\supptheory{Observation~1}{Permutations form a small bijective core}
...
place its elementary writes inside a two-layer automaton.\supptheory{Definition~2}{Genotype and phenotype}\supptheory{Worked example~2}{One site, one complete MetaCA step}
...
field.\supptheory{Definition~5}{Temporal braid}\suppfinding{3}{A braid of two collapsing operators can sustain the field}
...
length of the run rather than resolving to a homogeneous or short-period field.\supptheory{Definition~7}{River}\suppfinding{8}{The river sustains structured phenotype}
...
collide.\suppfinding{10}{Causal reach on a scale calibrated against elementary rules}\suppfinding{11}{The order parameter is the strength of the phenotype-to-genotype coupling}
