...
$\pm 4$ collapse.\suppfinding{6}{The tested per-trajectory metrics do not separate the parity classes} A reader is entitled to ask whether that phase sits at a
...
dynamical regimes.\suppfinding{7}{No finite-size evidence of a critical point over the tested range}
...
length of the run rather than resolving to a homogeneous or short-period field.\suppnote{\supptheorytext{Definition~7}{River} \suppfindingtext{8}{The river sustains structured phenotype}}
...
phenotype-to-genotype edge cut. Figure~\ref{fig:river-perturbation} sweeps the flip over all $80$ sites and records damage at a sequence of horizons.\suppfinding{9}{Phenotype-to-genotype feedback roughly doubles causal reach}
...
collide.\suppnote{\suppfindingtext{10}{Causal reach on a scale calibrated against elementary rules} \suppfindingtext{11}{The order parameter is the strength of the phenotype-to-genotype coupling}}
...
graded, monotone function of it.\suppfinding{12}{Coupling is a dial, not a switch, and reach is monotone along it}
...
collapses during the very window the damage is measured in.\suppfinding{13}{Sustained diversity does not determine causal reach; conservative transport breaks the apparent interior optimum}
...
permutations or all writings. Supplement~4 records the separate spatial-domain
