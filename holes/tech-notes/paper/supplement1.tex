...
\abstract{%
This notebook collects the thirteen empirical findings referenced from the main
...
claims that those materials support.}
...
\texttt{supplement1-findings.tex} is canonical: the main paper contains pointers,
not duplicate finding text.
