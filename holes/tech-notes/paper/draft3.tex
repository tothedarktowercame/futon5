...
dominated by the intermediate complex Rule~110 ($\approx 44\%$;
Figure~\ref{fig:regimes}). The score orders the regimes but does not by itself
separate complex from chaotic, a known-hard distinction.}
\label{fig:tint}
\end{figure}
