...
\paragraph{Code availability.} All code needed to reproduce the figures in this
paper is available at \texttt{https://github.com/tothedarktowercame/mmca-clj}---a
standalone, dependency-light Clojure port of the MetaCA dynamics whose
\texttt{README} gives the exact command for each figure.
