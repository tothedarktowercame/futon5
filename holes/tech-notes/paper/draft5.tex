...
\centering
\begin{tikzpicture}
\node[inner sep=0.4pt, draw=black!25] (p) {\includegraphics[width=56mm]{figures/eoc_patch.png}};
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.85\linewidth]{figures/edge_of_chaos_curve.png}
