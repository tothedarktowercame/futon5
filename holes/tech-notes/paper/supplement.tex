...
\externaldocument[S1-]{supplement1}
...
The finite-size scan of the main paper (\emph{Supplement 1, Box~\ref{S1-find:crossover}},
...
\emph{Supplement 1, Box~\ref{S1-find:braid}}) into a
...
\emph{Supplement 1, Box~\ref{S1-find:river}}) produces coherent bands that drift through a
