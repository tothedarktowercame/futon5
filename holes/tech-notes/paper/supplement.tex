...
\title{Supplement to \emph{Rule-Rewriting Cellular Automata and the Edge of Chaos}}
...
This supplement carries three strands of the companion paper that are reported
...
The finite-size scan of the main paper (Empirical finding~\ref{find:crossover},
