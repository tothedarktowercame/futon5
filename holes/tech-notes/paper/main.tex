...
the 20{,}256 propagator orbits form a continuum with no natural joints.
We offer the fail bank as the contribution, with two surviving methods: a certified mean-field
bound making 205M transport distances tractable, and Ollivier--Ricci
curvature as navigation for a space with no clusters.}
