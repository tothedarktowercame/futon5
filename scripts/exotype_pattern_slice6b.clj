(ns exotype-pattern-slice6b
  "Slice 6b: corrected, stigmergic Beta-posterior EIG. Measurements only."
...
(def config
  {:seed-base 20260803 :seeds 60 :width 80 :steps 6000 :workers 12
   ...
   :arms pattern/arms :eig-model :beta-posterior})
(def paths
  {:raw "reports/exotype-pattern-slice6b.raw.edn"
   :edn "reports/exotype-pattern-slice6b.edn"
   :md "reports/exotype-pattern-slice6b.md"
   :figure-prefix "reports/figures/slice6b"})
...
(defn markdown [result]
  (str "# Exotype patterns and local EIG — Slice 6b\n\n"
