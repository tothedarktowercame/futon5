...
(defn- usage []
  (str/join
   "\n"
   ["Excursion 1 Stage 2: Ablation and boundary mapping"
    ""
    "Usage:"
    "  bb -cp futon5/src:futon5/resources futon5/scripts/excursion_1_stage_2.clj [options]"
    ""
    "Options:"
    "  --seeds PATH       EDN vector of seeds (required)."
    "  --arms PATH        EDN map of ablation arms (required)."
    "  --length N         Genotype/phenotype length (default 80)."
    "  --generations N    Generations (default 100)."
    "  --out-dir PATH     Output directory (default /tmp/excursion-1-stage-2)."
