...
- Pilot result (contexts=5, k=2, tau=0.6): 58 arrows found after coarse regime signature (word-class only).

** Sample arrow

#+begin_src clojure
{:from {:regime :unknown, :sig :unknown}
 :witness {:term [:set-exotype "一" :local], :cost 1}
 :to {:word-class :oscillating, :sig -1301417310}
 :robustness {:tau 1.0, :contexts 5}}
#+end_src
