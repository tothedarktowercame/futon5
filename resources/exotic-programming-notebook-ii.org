...
- MVP uses a tiny term grammar and three coarse regimes (:dead/:stable/:oscillating/:chaotic).
- Output is a single EDN payload with discovered arrows and robustness.
- Pilot result (contexts=3, k=1): 0 arrows found; expand grammar or k if needed.
